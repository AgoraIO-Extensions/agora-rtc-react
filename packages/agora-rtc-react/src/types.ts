...
export interface JoinOptions {
  ...
  /**
   * The name of the channel to join. See [`IAgoraRTCClient.join`](https://api-ref.agora.io/en/video-sdk/reactjs/2.x//IAgoraRTCClient.join.html) for details.
   */
  channel: string;

  /**
   * The token used for authentication. If token-based authentication is enabled for your project, a valid token must be provided. If token-based authentication is not enabled, you can pass `null`. See [`IAgoraRTCClient.join`](https://api-ref.agora.io/en/video-sdk/reactjs/2.x//IAgoraRTCClient.join.html) for details.
   */
  token: string | null;

  /**
   * The user ID. If not provided, the Agora server assigns a number `uid` for you. See [`IAgoraRTCClient.join`](https://api-ref.agora.io/en/video-sdk/reactjs/2.x//IAgoraRTCClient.join.html) for details.
   */
  uid?: UID | null;
}
