 ...
 *
 * @param `audioTrack` {IRemoteAudioTrack | ILocalAudioTrack | undefined} The local or remote audio track. The local audio track can be created by calling [`useLocalMicrophoneTrack`](#uselocalmicrophonetrack). If undefined, the volume level is 0.
