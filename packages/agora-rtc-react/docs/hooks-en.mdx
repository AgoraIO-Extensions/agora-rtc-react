...
| 参数名       | 类型                                                                                     | 是否必选 | 描述                                             |
| ------------ | ---------------------------------------------------------------------------------------- | -------- | ------------------------------------------------ |
| `audioTrack` | `IRemoteAudioTrack `<code>&#124;</code>`ILocalAudioTrack`<code>&#124;</code>` undefined` | 可选     | 本地或远端音频轨道。如果未定义，则音量级别为 0。 |
...
| 参数名   | 类型                                         | 是否必选 | 描述                                                                                                         |
| -------- | -------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------ |
| `client` | `IAgoraRTCClient `<code>&#124;</code>` null` | 可选     | 如果传入该参数，则使用传入的 `IAgoraRTCClient` 对象；如果不传入该参数，则使用返回的 `IAgoraRTCClient` 对象。 |
...
| 类型                                         | 描述                     |
| -------------------------------------------- | ------------------------ |
| `IAgoraRTCClient `<code>&#124;</code>` null` | `IAgoraRTCClient` 对象。 |
...
| 参数名      | 类型                                                        | 是否必选 | 描述                                                                                                                                          |
| ----------- | ----------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `fetchArgs` | `FetchArgs        `<code>&#124;</code>` () => Promise<any>` | 必选     | 获取加入频道所需参数的函数或对象。                                                                                                            |
...
| `token`   | `string                                      `<code>&#124;</code>` null` | 必选     | 用于鉴权的 Token，如果频道启用了 Token 鉴权机制，则需要提供有效的 Token；如果没有启用 Token 鉴权，则传入 `null`。详见 [join](https://docportal.shengwang.cn/cn/live-streaming-premium-4.x/API%20Reference/web_ng/interfaces/iagorartcclient.html#join) 的参数说明。 |
| `uid`     | `UID                                         `<code>&#124;</code>` null` | 可选     | 用户 ID，如果不提供则由服务器自动生成。详见 [join](https://docportal.shengwang.cn/cn/live-streaming-premium-4.x/API%20Reference/web_ng/interfaces/iagorartcclient.html#join) 的参数说明。                                                                           |
| `client`  | `IAgoraRTCClient `<code>&#124;</code>` null`                             | 可选     | [IAgoraRTCClient](https://docportal.shengwang.cn/cn/live-streaming-premium-4.x/API%20Reference/web_ng/interfaces/iagorartcclient.html) 对象。                                                                                                                       |
...
| 参数名           | 类型                                             | 是否必选 | 描述                                                                                                                                          |
| ---------------- | ------------------------------------------------ | -------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `tracks`         | `(ILocalTrack     `<code>&#124;</code>` null)[]` | 必选     | 本地轨道列表。                                                                                                                                |
...
| 类型                                           | 描述                 |
| ---------------------------------------------- | -------------------- |
| `ICameraVideoTrack `<code>&#124;</code>` null` | 摄像头视频轨道对象。 |
...
| 参数名   | 类型                                                    | 是否必选 | 描述                                                                                                                                            |
| -------- | ------------------------------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| `users`  | `IAgoraRTCRemoteUser[] `<code>&#124;</code>` undefined` | 必选     | 远端用户列表。                                                                                                                                  |
| `client` | `IAgoraRTCClient       `<code>&#124;</code>` null`      | 可选     | [IAgoraRTCClient](https://docportal.shengwang.cn/cn/live-streaming-premium-4.x/API%20Reference/web_ng/interfaces/iagorartcclient.html) 对象。。 |
...
| 参数名  | 类型                                                       | 是否必选 | 描述                                                                                                   |
| ------- | ---------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------ |
| `track` | `IRemoteVideoTrack `<code>&#124;</code>` ILocalVideoTrack` | 必选     | 远端视频轨道对象或本地视频轨道对象。                                                                   |
| `play`  | `boolean`                                                  | 可选     | 是否播放视频轨道。                                                                                     |
| `div`   | `HTMLElement       `<code>&#124;</code>` null`             | 可选     | 用于渲染视频的 HTML 元素。如果提供了该参数，视频将在该元素中自动播放。如果未提供，则不会自动播放视频。 |
