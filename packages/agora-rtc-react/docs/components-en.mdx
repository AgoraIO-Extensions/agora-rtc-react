...
| `volume`           | `number`                                                                                                                                         | None                                                                                                                                                           | The volume. The value ranges from 0 (mute) to 100 (the original volume).                                                                                                                                                                                                                                                                                                                                                       |
| `cover`            | `string` &#124; `() => ReactNode`                                                                                                                | None                                                                                                                                                           | The cover image or custom component to be displayed when `playVideo` is `false`, replacing the video frame. You can pass the URL of an online image or the relative path of a local image.                                                                                                                                                                                                                                     |
| `children`         | `ReactNode`                                                                                                                                      | None                                                                                                                                                           | The React nodes to be rendered.                                                                                                                                                                                                                                                                                                                                                                                                |
