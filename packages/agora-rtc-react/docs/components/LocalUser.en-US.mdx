...
If you need the capability to set the microphone or camera device, use the Web SDK's [`IMicrophoneAudioTrack.setDevice`](https://api-ref.agora.io/en/video-sdk/reactjs/2.x//IMicrophoneAudioTrack.setDevice.html) or [`ICameraVideoTrack.setDevice`](https://api-ref.agora.io/en/video-sdk/reactjs/2.x//ICameraVideoTrack.setDevice.html) method.
