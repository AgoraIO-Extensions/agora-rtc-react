import{j as r}from"./jsx-runtime-94f6e698.js";import{a as b}from"./chunk-OPEUWD42-a3b45fd8.js";import{r as s}from"./index-8db94870.js";import{u as L,F as w,a as A}from"./styles-050b788a.js";import{F as x,L as C}from"./LocalAudioTrack-046cd86e.js";import{F as O,L as P}from"./LocalVideoTrack-fe58b9c1.js";import{U as R,F as U,A as F}from"./useRTCClient-c750e90a.js";import"./_commonjsHelpers-042e6b4d.js";import"./quick-mechanical-keyboard-14391-c203a4f2.js";import"./TrackBoundary-09ed2e35.js";import"./local-track-79ab083b.js";import"./remote-audio-track-c9f9a53d.js";import"./remote-track-9cd6f7b1.js";import"./remote-video-track-08a58b5b.js";class d extends O{static create(e){return new d(e)}async setDevice(e){console.log("[FakeCameraVideoTrack]: setDevice",e)}}class u extends x{static create(e){return new u(e)}async setDevice(e){console.log("[FakeMicrophoneAudioTrack]: setDevice",e)}}function m({micOn:c,cameraOn:e,audioTrack:i,videoTrack:l,playAudio:a,playVideo:n,volume:o,cover:p,children:k,style:v,...g}){const y=L(A,v);return n=n??!!e,a=a??!!c,r.jsxs("div",{...g,style:y,children:[r.jsx(P,{disabled:!e,play:n,track:l}),r.jsx(C,{disabled:!c,play:a,track:i,volume:o}),p&&!e&&r.jsx(R,{cover:p}),r.jsx("div",{style:w,children:k})]})}m.__docgenInfo={description:`This component plays the camera video track and the microphone audio track of the local user using the playback devices selected by the user in the browser.
@example
\`\`\`jsx
...
//# sourceMappingURL=LocalUser.stories-8f3732b0.js.map
