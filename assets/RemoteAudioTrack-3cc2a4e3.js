import{j as a}from"./jsx-runtime-94f6e698.js";import{r as s}from"./index-8db94870.js";import{u as i}from"./TrackBoundary-09ed2e35.js";function u({track:e,play:n=!1,playbackDeviceId:o,volume:r,children:t}){return i(e,n),s.useEffect(()=>{e&&o!=null&&e.setPlaybackDevice(o).catch(console.warn)},[e,o]),s.useEffect(()=>{e&&r!=null&&e.setVolume(r)},[e,r]),t?a.jsx(a.Fragment,{children:t}):null}u.__docgenInfo={description:`This component plays the audio track of a remote user with the playback device you specify.
@example
\`\`\`jsx
...
//# sourceMappingURL=RemoteAudioTrack-3cc2a4e3.js.map
